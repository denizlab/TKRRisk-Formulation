...
class Contloader():
    def __init__(self, train,normalize,randomCrop,randomFlip,flipProbability,cropDim,year="1yr",contrast = "SAG_IW_TSE"):
        self.train = train
        self.normalize = normalize
        self.randomCrop = randomCrop
        self.randomFlip = randomFlip
        ...
        self.data_path = "/gpfs/data/denizlab/Datasets/OAI/"+contrast+"/"
    ...
    def __getitem__(self, idx):
        ...
        if Side ==0:
            f_name = "_LEFT_"+self.contrast+".hdf5"
        else:
            f_name = "_RIGHT_"+self.contrast+".hdf5"
