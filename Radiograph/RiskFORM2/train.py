...
def main() -> None:
    ...
    for cv in range(1,7):
        ...
        model1= get_model(tl_model,mode,image_size,cropped_size,hidden_dim,layer_dim,dropout,output_dim,device,types=types).to(device)
        model2= get_model(tl_model,mode,image_size,cropped_size,hidden_dim,layer_dim,dropout,output_dim,device,types=types).to(device)
